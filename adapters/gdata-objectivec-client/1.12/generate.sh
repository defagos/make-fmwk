...
rm -rf "$GENERATED_SOURCE_DIR/HTTPFetcher/Tests"
rm -rf "$GENERATED_SOURCE_DIR/HTTPFetcher/GTMHTTPFetcher.xcodeproj"
rm -r "$GENERATED_SOURCE_DIR/HTTPFetcher/UnitTests-Info.plist"
rm -r "$GENERATED_SOURCE_DIR/HTTPFetcher/ReleaseNotes.txt"
rm -rf "$GENERATED_SOURCE_DIR/OAuth2/GTMOAuth2.xcodeproj"
rm -rf "$GENERATED_SOURCE_DIR/OAuth2/Mac"
rm -f "$GENERATED_SOURCE_DIR/OAuth2/ReleaseNotes.txt"
